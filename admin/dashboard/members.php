                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($row['is_blocked'] == 1): ?>
                                        <a href="block_member.php?id=<?= $row['id']; ?>&action=unblock" class="btn btn-success btn-sm" title="Unblock">
                                            <i class="bi bi-unlock"></i> Unblock
                                        </a>
                                    <?php else: ?>
                                        <a href="block_member.php?id=<?= $row['id']; ?>&action=block" class="btn btn-danger btn-sm" title="Block">
