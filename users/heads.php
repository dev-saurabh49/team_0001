...
<body>
    ...
    <nav id="sidebar" class="sidebar">
        ...
        <ul class="nav flex-column px-2">
            ...
            <li><a href="./terms.php" class="nav-link"><i class="bi bi-bar-chart"></i> Terms & Conditions</a></li>
            <!-- <li><a href="./meetings.php" class="nav-link"><i class="bi bi-bar-chart"></i> Meetings</a></li> -->
